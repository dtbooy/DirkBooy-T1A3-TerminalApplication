...
def test_edit_file(monkeypatch):
    ...
    monkeypatch.setattr("file_handling.playquiz.clear_screen", lambda: print("clear screen"))    
    ...
    original_question_list = file_handling.get_question_list_from_file(topic_list[0])
    ...
    final_question_list = file_handling.get_question_list_from_file(topic_list[0])
